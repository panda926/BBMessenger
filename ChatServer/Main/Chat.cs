...
namespace ChatServer
{
    ...
    //    public List<UserInfo> _listUserInfo = new List<UserInfo>();
    //}
    ...
    public class Chat : BaseInfo
    {
        ...
        public static List<RoomInfo> _Meetings = new List<RoomInfo>();
        //public static List<MeetingInfo> _listMeetingInfo = new List<MeetingInfo>();
        ...
        public List<RoomInfo> GetListRoomInfo()
        {
            return _Meetings;
        }
        ...
        public UserInfo OutMeeting(Socket socket, RoomInfo roomInfo)
        {
            UserInfo userInfo = Users.GetInstance().FindUser(socket);
            ...
            string meetId = roomInfo.Id.Trim();
        ...
        public void BroadCast(string roomId, NotifyType notifyType, BaseInfo sendInfo, string ownerId)
        {
            ...
            if (ownerId != null)
            {
                UserInfo ownerUserInfo = Users.GetInstance().GetUsers().Find(item => item.Id == ownerId);
