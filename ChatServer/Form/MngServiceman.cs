...
{
    public partial class MngServiceman : Form
    {
        public MngServiceman()
        {
            InitializeComponent();
        }
        ...
        {
            string queryStr = string.Format("select * from tblUser where Kind={0} ", (int)UserKind.ServiceWoman);
            ...
            for (int i = 0; i < userList.Count; i++)
            {
                ...
                try
                {
                    Image faceImage = Image.FromFile("\\\\127.0.0.1\\" + userInfo.Icon);
                ...
                UserView.RowTemplate.Height = 45;
        ...
        private void buttonAddUser_Click(object sender, EventArgs e)
        {
            ...
            addUser._Kind = (int)UserKind.ServiceWoman;
        ...
        private void buttonEditUser_Click(object sender, EventArgs e)
        {
            ...
            editUser._Kind = (int)UserKind.ServiceWoman;
        ...
        private void buttonNewCount_Click(object sender, EventArgs e)
        {
            ...
            managerEvaluation._UserId = userId;
